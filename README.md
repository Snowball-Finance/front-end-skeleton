...
for the base components, we will use MUI5 components and for styling them we will use [styled() approach](https://mui.com/system/styled/) (READ THE dOCS ON styled())
